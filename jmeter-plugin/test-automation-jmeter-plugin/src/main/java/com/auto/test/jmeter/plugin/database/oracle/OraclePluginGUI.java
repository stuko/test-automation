...
public class OraclePluginGUI extends AbstractGUI {

	static Logger logger = LoggerFactory.getLogger(OraclePluginGUI.class);
	...
	protected void configureTestElement(TestElement mc) {
		...
		if (mc instanceof OracleSampler) {
			OracleSampler cSampler = (OracleSampler) mc;
		}
	}
	...
	public void init(JPanel mainPanel, GridBagConstraints labelConstraints, GridBagConstraints editConstraints) {
		...
		this.OC_URL.setText("jdbc:oracle:thin:@192.168.57.160:1521/kcbdls01");
		this.OC_DRIVER.setText("oracle.jdbc.OracleDriver");
		...
		this.OC_NAME.setText("Oracle Plugin Test Connection");
		this.OC_ID.setText("kcbdev");
		this.OC_PW.setText("kcbdev1234");
	...
	public TestElement createTestElement() {
		OracleSampler sampler = new OracleSampler();
	...
	private void initSampler(OracleSampler sampler) {
		sampler.setComment("Oracle Plugin Sampler");
	...
	public void modifyTestElement(TestElement sampler) {
		...
		if (sampler instanceof OracleSampler) {
			OracleSampler cSampler = (OracleSampler) sampler;
