 ...
 * @author O218001_D
 */
public class TaPluginTestResultForm extends javax.swing.JFrame {

    static Logger logger = LoggerFactory.getLogger(TaPluginTestResultForm.class);
    ...
    /**
     * Creates new form Tapluginform
     */
    public TaPluginTestResultForm() {
        initComponents();
    }
    ...
    private void fetchTestResultData() throws Exception {
        ...
        test_result_queue = FileJsonArrayListQueue.getInstanceMap("resultMap", TestPluginConstants.ta_data_path);
    ...
    private void fetchTestExpectData() throws Exception {
        ...
        // 테스트 결과를 저장 할 File queue
        test_expect_queue = FileJsonArrayListQueue.getInstanceMap("expectMap", TestPluginConstants.ta_data_path);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TaPluginTestResultForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TaPluginTestResultForm().setVisible(true);
            }
        });
    }
