...
public class TestAutomationGuiController {
    ...
    static String kafka = "{\n" +
            "\"server\":\"localhost:9092,localhost:9092,localhost:9092\"\n" +
            ",\"topic\":\"topic\"\n" +
            "}";
    static String http = "{\n" +
    ...
    public static String getKafkaText() {
        return kafka;
    }
    ...
    public static boolean show_project_detail(JList list
            ...
            ,JTextArea project_desc) throws Exception{
        if(list != null){
    ...
    public static boolean get_test_data_by_jmx(TestDataFactorReceiver receiver) throws Exception{
    ...
    public static boolean save_project_connection_info(javax.swing.JList list
            ...
            , String test_exec_shell) throws Exception{
        if(list != null){
            Map<String,String> param = new HashMap<>();
            String selected_data = (String)list.getSelectedValue();
            if(list.getSelectedValue() == null){
    ...
    public static void save_factors(Map<String,Object> param) throws Exception{
        HttpUtil.call(TEST_URL+"save_factors",gson.toJson(param),(body)->{
               logger.info(body);
        });
    }
    
    public static void save_run_config(Map<String,Object> param) throws Exception{
    ...
    public static void save_test_scenario() throws Exception{
