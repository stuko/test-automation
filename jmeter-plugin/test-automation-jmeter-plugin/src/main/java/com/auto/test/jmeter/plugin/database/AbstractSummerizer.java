...
public abstract class AbstractSummerizer extends AbstractTestElement
		implements Serializable, SampleListener, TestStateListener, NoThreadClone, Remoteable {

	private static final Logger logger = LoggerFactory.getLogger(AbstractSummerizer.class);
	...
	public void sampleOccurred(SampleEvent e) {
		...
		synchronized (totals) {
		 ...
		 calculateQueryTime(s);
		
	}
 
	public abstract void calculateQueryTime(SampleResult s);
