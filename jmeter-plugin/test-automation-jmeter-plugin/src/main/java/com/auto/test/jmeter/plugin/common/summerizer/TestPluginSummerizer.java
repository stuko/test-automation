package com.auto.test.jmeter.plugin.common.summerizer;
...
public class TestPluginSummerizer extends AbstractTestElement
		implements Serializable, SampleListener, TestStateListener, NoThreadClone, Remoteable {

	private static final Logger logger = LoggerFactory.getLogger(TestPluginSummerizer.class);
	...
	protected AbstractRunningSampleWrapper newRunningSampleWrapper(String label){
		// abstract
		return new AbstractRunningSampleWrapper(label);
	}

	public static class AbstractRunningSampleWrapper {
