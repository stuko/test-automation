package com.kcb.fds.jmeter.plugin.common.factor;

import com.kcb.fds.jmeter.plugin.common.factor.define.SubstringMessageFactorImpl;
import com.kcb.fds.jmeter.plugin.common.factor.range.TestPluginMessageFactorRangeCollection;
import com.kcb.fds.jmeter.plugin.common.factor.value.TestPluginMessageFactorFileValue;
import com.kcb.fds.jmeter.plugin.common.factor.value.*;
...
public class TestPluginMessageFactorImplFactory extends SubstringMessageFactorImpl {
    ...
    public TestPluginMessageFactorRangeCollection getFactorRange(){
        ...
        if(this.getType() == null){
            ...
            f.setFdsPluginMessageFactor(this);
