...
import com.kcb.fds.jmeter.plugin.common.factor.define.TestPluginMessageFactor;
...
public class TestPluginMessageFactorDatetimeValue  extends AbstractTestPluginMessageFactorValueImpl{
    ...
    private String getDateTime(int gap, Unit unit , String format){
        ...
        if(this.getFdsPluginMessageFactor().isSubstring()){
            date = date.substring(this.getFdsPluginMessageFactor().getSubstring_first_index(),this.getFdsPluginMessageFactor().getSubstring_second_index());
        }
        return date;
    }
